...
# AGENTS.md — chatbot-juridico-rjl
...
- **AI:** Anthropic Codex (`Codex-sonnet-4-5-20251022`) — SERVER-SIDE ONLY
...
src/
├── app/
│   ├── api/chat/route.ts          ← Proxy seguro a Codex
...
├── lib/
│   ├── anthropic.ts               ← Codex client (server-only)
